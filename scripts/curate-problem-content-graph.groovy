...
def definitions = [
    'leadership-bottleneck': [
        ...
        problems: ['langsame-entscheidungen', 'leadership-transition', 'unklare-prioritaeten'],
    ...
    'langsame-entscheidungen': [
        ...
        problems: ['leadership-bottleneck', 'ai-decision-rights', 'unklare-prioritaeten'],
    ...
    'unklare-prioritaeten': [
        ...
        problems: ['langsame-entscheidungen', 'leadership-bottleneck'],
        insightSlugs: ['annahmen-vor-einer-produktentscheidung-pruefen', 'warum-produktorganisationen-nicht-an-fehlenden-methoden-scheitern'],
        caseSlugs: ['prioritaetsentscheidung-beginnt-von-vorn'],
        offerNames: ['chos-clarity-session', 'decision-review']
    ]
]
...
println 'Diagnosefragen, Anti-Patterns und Related Content der fünf Problemsituationen redaktionell kuratiert und veröffentlicht.'
